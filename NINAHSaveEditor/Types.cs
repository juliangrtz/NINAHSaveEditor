...
namespace NINAHSaveEditor {
    public static class Types {
        ...
        public static string DayNightController = "_Code.Infrastructure.DayNight.DayNightController";
        public static string DayNightSavesData = DayNightController + Crap;
    }
}
